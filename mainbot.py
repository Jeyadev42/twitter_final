...
while True:
    user = api.get_user('JeyadevL')
    api.update_profile(name=f'jeyadevl|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : jeyadevl|{follower_count(user)} Followers')
